                                                            ...
                                                            <div class="item">
                                                                <div class="py-3">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <p class="font-size-14 mb-0">- Fibrox3d User</p>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="my-auto">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted">Get your free Fibrox3d account now.</p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <form class="needs-validation" novalidate action="index">
                                                ...
                                                <div>
                                                    <p class="mb-0">By registering you agree to the Fibrox3d <a href="#"
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>
                                            ...
                                            </script> Fibrox3d. Crafted with <i class="mdi mdi-heart text-danger"></i> by
                                            Themesbrand</p>
                                    </div>
                                </div>
