...
@section('title') Mould Data @endsection
            ...
            <div class="row gy-2 gx-3 align-items-center" style="justify-content: right;">
                                ...
                                <div class="col-sm-auto" style="margin-bottom: 10px;">
                                    <select id="select222" class="form-control select2-multiple" multiple="multiple"
                                        data-placeholder="Mould / Part Name" onchange="return gettabledata();">
                ...
                <table id="datatableworkdata" class="table table-sm m-0 table-responsive" style="width: 100%!important">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width: 7%;">Committed Dt</th>  
                            <th style="width: 13%;">Customer Name</th>
                            <th style="width: 8%;">Work Type</th>
                            <th style="width: 8%;">Mould/Part Name</th>
 ...
 $('body').on('click','.editScan',function(){
    ...
    <script>
          function gettabledata(){
            ...
            var descriptionData = $("#select222").val();
            var userid = $("#select2222").val();
            var maindate = $("#rdate").val();
            // console.log(maindate);
            var url = "{{ route('getselecteddashboarddata') }}?customerids=" + customerIds.join(',')+"&worktype=" + worktype.join(',')+"&descriptiondata=" + descriptionData.join(',')+"&maindate="+ maindate;  
        ...
        $(function () {
                $('#datatableworkdata').DataTable({
                    ...
                    buttons: [  
                                ...
                                // 'print', 
                                'colvis'],
                    ajax: "{{route('getselecteddashboarddata')}}",
                    columns: [
                        {data : {'_': 'rdate.display', 'sort': 'rdate.timestamp'}, name: 'rdate', orderable: true},
                        {data : {'_': 'cdate.display', 'sort': 'cdate.timestamp'}, name: 'cdate', orderable: true},
                        {data: 'cname', name: 'cname',orderable: true, 
