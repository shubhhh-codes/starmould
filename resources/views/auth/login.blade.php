                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5">
                                    <a href="index" class="d-block auth-logo">
                                        <img src="{{ URL::asset('/assets/images/starmouldold.png') }}" alt="" style="width: 100%">
                                    </a>
                                </div>
                                <div class="my-auto" style="margin-top: 50px!important;">

                                    <div>
                                        <h5 class="text-primary">Welcome Back !</h5>
                                        <p class="text-muted">Sign in to continue to Star Mould.</p>
                                    </div>
                                ...
                                <div class="mt-4 mt-md-0 text-center">
                                    <p class="mb-0">© <script>
                                        ...
                                        </script> Star Mould. <br>Design & Develop by <i class="mdi mdi-heart text-danger"></i> Codewing Technology Pvt. Ltd.</p>
                                </div>
                            </div>
